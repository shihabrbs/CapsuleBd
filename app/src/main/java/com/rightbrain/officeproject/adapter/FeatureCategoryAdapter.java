...
public class FeatureCategoryAdapter extends RecyclerView.Adapter<FeatureCategoryAdapter.MyViewHolder> {
    Context context;
    ArrayList<Category> allcategory;

    public FeatureCategoryAdapter(Context context, ArrayList<Category> allcategory) {
