...
public class PromotionProductAdapterList extends RecyclerView.Adapter<PromotionProductAdapterList.MyViewHolder> {
    Context context;

    ArrayList<ModelProducts> allProducts;
    public List<ModelCartRoom> cartList;
    int counter = 0;
    public PromotionProductAdapterList(Context context, ArrayList<ModelProducts> allProducts) {
