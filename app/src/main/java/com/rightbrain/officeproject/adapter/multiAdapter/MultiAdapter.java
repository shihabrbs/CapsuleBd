...
public class MultiAdapter extends RecyclerView.Adapter{
    ...
    public MultiAdapter(Context context, List<Product> allcategory,int viewTypee) {
    ...
    class LargeLayout extends RecyclerView.ViewHolder {
        TextView productname,name,seeall,price,quntity,unitname,discountPercent,normalprice, offerprice;
        ImageView imageView,minusbtn,plusbtn;
        ConstraintLayout cart;
        ConstraintLayout constraintLayoutdis;
