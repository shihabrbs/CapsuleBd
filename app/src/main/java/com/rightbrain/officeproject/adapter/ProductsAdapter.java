...
public class ProductsAdapter extends RecyclerView.Adapter {
    ...
    public ProductsAdapter(ProductsActivity context, ArrayList<ModelProducts> allProducts, int viewTypee) {
        ...
        switch (viewTypee) {
            case GRID_VIEW_LAYOUT:
                ...
                ((GridLayout) holder).plusbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    //   Toast.makeText(context, ""+allProducts.get(position).getMaxQuantity(), Toast.LENGTH_SHORT).show();
            ...
            case LIST_VIEW_LAYOUT:
                ...
                ((ListLayout) holder).plusbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        int maxqnt2 =  allProducts.get(position).getMaxQuantity();
                        String qntapplicable2 =  ""+allProducts.get(position).getQuantityApplicable();
                        ...
                        if (quantity > 0) {
                         /*   int productid = allProducts.get(position).getProductId();
                            ...
                            if (qntapplicable2.equals("true")){
                                if (quantity==maxqnt2){
                                    Toast.makeText(context, "You can't get more then "+maxqnt2, Toast.LENGTH_SHORT).show();
                                }else {
                                    int productid = allProducts.get(position).getProductId();
                                    quantity++;
            ...
            case LARGE_VIEW_LAYOUT:
                ...
                repository.getAllData().observe((LifecycleOwner) context, new Observer<List<ModelCartRoom>>() {
                    ...
                    public void onChanged(List<ModelCartRoom> cartList) {
                        for (ModelCartRoom cart : cartList) {
                            if (cart.getProductId().equals(String.valueOf(allProducts.get(position).getProductId()))) {
                                ((LargeLayout) holder).quntity.setText(cart.getQuantity());
                ...
                String disountpercentt3 = "" + allProducts.get(position).getDiscountAmount();
                ...
                ((LargeLayout) holder).plusbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        int maxqnt3 =  allProducts.get(position).getMaxQuantity();
                        String qntapplicable3 =  ""+allProducts.get(position).getQuantityApplicable();
                        ...
                        if (quantity > 0) {
                           /* int productid = allProducts.get(position).getProductId();
                            ...
                            if (qntapplicable3.equals("true")){
                                if (quantity==maxqnt3){
                                    Toast.makeText(context, "You can't get more then "+maxqnt3, Toast.LENGTH_SHORT).show();
                                }else {
                                    int productid = allProducts.get(position).getProductId();
                                    quantity++;
    ...
    class LargeLayout extends RecyclerView.ViewHolder {
        TextView productname, name, seeall, discountPercent, quntity, unitname, normalprice, offerprice;
        ImageView imageView, minusbtn, plusbtn;
        ConstraintLayout cart;
        ConstraintLayout constraintLayoutdis;
