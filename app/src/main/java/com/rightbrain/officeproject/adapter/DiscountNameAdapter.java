...
public class DiscountNameAdapter extends RecyclerView.Adapter<DiscountNameAdapter.MyViewHolder> {
    Context context;
    List<DiscountItem> allcategory;
    private ItemClickListener clickListener;
    private int row_index = 0;

    public DiscountNameAdapter(Context context, List<DiscountItem> allcategory) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            clickListener.onClickdiscountt(view,getAdapterPosition());
        }
    }
}
