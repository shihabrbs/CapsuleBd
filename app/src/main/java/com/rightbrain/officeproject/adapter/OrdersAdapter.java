...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.MyViewHolder> {
    ...
    Context context;
    ArrayList<ModelOrderList> allcategory;

    public OrdersAdapter(Context context, ArrayList<ModelOrderList> allcategory) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        //Toast.makeText(context, ""+timearrylist.get(0).getDate(), Toast.LENGTH_SHORT).show();
       ...
       // holder.date.setText("" + timearrylist.get(position).getDate());
