...
public class SearchAdapter extends RecyclerView.Adapter {
    ...
    public SearchAdapter(Context context, ArrayList<ModelProducts> allcategory,int viewTypee) {
   ...
   /* public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    class LargeLayout extends RecyclerView.ViewHolder {
        TextView productname,name,seeall,quntity,unitname, normalprice, offerprice;
        ImageView imageView, minusbtn,plusbtn;
        ConstraintLayout cart;
        ConstraintLayout constraintLayoutdis;
