...
public class DiscountProductAdapter extends RecyclerView.Adapter {
    ...
    public DiscountProductAdapter(ProductsActivity context, ArrayList<ModelProducts> allProducts,int viewTypee) {
    ...
    class LargeLayout extends RecyclerView.ViewHolder {
        TextView productname,name,seeall,price,quntity,unitname,normalprice, offerprice,discountPercent;
        ImageView imageView,minusbtn,plusbtn;
        ConstraintLayout cart;
        ConstraintLayout constraintLayoutdis;
