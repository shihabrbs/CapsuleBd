...
public class DiscountProductAdapterList extends RecyclerView.Adapter<DiscountProductAdapterList.MyViewHolder> {
    ProductsActivity context;

    ArrayList<ModelProducts> allProducts;
    public List<ModelCartRoom> cartList;
    int counter = 0;
    public DiscountProductAdapterList(ProductsActivity context, ArrayList<ModelProducts> allProducts) {
